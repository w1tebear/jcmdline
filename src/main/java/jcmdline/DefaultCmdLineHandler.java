 ...
 * command's usage. These options are (using the default 'strings' properties
 * file):
 * 
 * <pre>
 ...
 * @version jcmdline Rel. @VERSION@ $Id: DefaultCmdLineHandler.java,v 1.2
...
public class DefaultCmdLineHandler extends AbstractHandlerDecorator {
	...
	/**
	 * a parameter that will cause the usage to be displayed, including hidden
	 * options
	 */
	...
	public DefaultCmdLineHandler(CmdLineHandler handler) {
		super(handler);
		usageParam1 = new BooleanParam(Strings
				.get("DefaultCmdLineHandler.usageOptTag1"), Strings
				.get("DefaultCmdLineHandler.usageOptDesc"));
		usageParam1.setIgnoreRequired(true);
		usageParam2 = new BooleanParam(Strings
				.get("DefaultCmdLineHandler.usageOptTag2"), Strings
				.get("DefaultCmdLineHandler.usageOptDesc"));
		usageParam2.setIgnoreRequired(true);
		hiddenUsageParam = new BooleanParam(Strings
				.get("DefaultCmdLineHandler.hiddenUsageOptTag"), Strings
				.get("DefaultCmdLineHandler.hiddenUsageOptDesc"),
				BooleanParam.HIDDEN);
		hiddenUsageParam.setIgnoreRequired(true);
		setCustomOptions(new Parameter[] { usageParam1, usageParam2,
				hiddenUsageParam });
	}
	 ...
	 */
	public DefaultCmdLineHandler(String cmdName, String cmdDesc,
	 ...
	 *         returning, if one of its supported options (<i>-h</i>,
	 *         <i>-h!</i>, or <i>-?</i>) is specified. Otherwise,
