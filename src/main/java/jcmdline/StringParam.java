 ...
 * @version jcmdline Rel. @VERSION@ $Id: StringParam.java,v 1.3 2005/02/06
 *          23:42:23 lglawrence Exp $
 * @see CmdLineParser
 */
public class StringParam extends AbstractParameter<String> {
	...
	public static final String DEFAULT_OPTION_LABEL = Strings
			.get("StringParam.defaultOptionLabel");
	 ...
	 * getMinValLen() or getMaxValLen() to see whether a min/max had been set,
	 * but will cause an Exception to be thrown if passed to setMaxValLen() or
	 * setMinValLen().
	 */
	 ...
	 * 
	 * @return The maximum acceptable length for string value. This will be
	 *         equal to StingParam.UNSPECIFIED_LENGTH if it had never been set.
	 */
	 ...
	 * 
	 * @return the minimum acceptable length for string value This will be equal
	 *         to 0 if it had never been set.
	 */
	 ...
	 * @throws IllegalArgumentException
	 *             if <code>maxValLen
     *                      </code> less than 0, or is less than
	 *             <code>minValLen
     *                      </code>.
	 * @deprecated This method deprecated in favor of setMaxValLen(), which is
	 ...
	 *            the minimum acceptable length
	 * @throws IllegalArgumentException
	 *             if <code>minValLen</code> less than 0, or is greater than
	 *             <code>maxValLen
     *                      </code>.
	 */
	 ...
	 *             if <code>value
     *                      </code> is not valid with regard to
	 *             the minimum and maximum lengths, and the acceptableValues.
	 */
	public void validateValue(String val) throws CmdLineException {
		...
		if (minValLen != UNSPECIFIED_LENGTH && val.length() < minValLen) {
			throw new CmdLineException(Strings.get("StringParam.valTooShort",
					new Object[] { tag, new Integer(minValLen) }));
		}
		if (maxValLen != UNSPECIFIED_LENGTH && val.length() > maxValLen) {
			throw new CmdLineException(Strings.get("StringParam.valTooLong",
